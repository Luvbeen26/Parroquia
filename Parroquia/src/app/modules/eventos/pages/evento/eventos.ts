...
export class Eventos {
  eventosList=[
    { nombre:"Bautizo", image:"img/bautizo.png",
    ...
    { nombre:"Confirmacion", image:"img/confirmacion.png",
    ...
    { nombre:"Primera Comunion", image:"img/primer.png",
    ...
    { nombre:"Matrimonio", image:"img/matrimonio.png",
    ...
    { nombre:"XV Años", image:"img/xv.png",
